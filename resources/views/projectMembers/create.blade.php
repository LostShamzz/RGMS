        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('projectMembers.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="research_grant_id" class="block text-white dark:text-gray-200">Research Grant</label>
                        ...
                        <div class="mb-4">
                            <label for="project_leader" class="block text-white dark:text-gray-200">Project Leader</label>
                        ...
                        <div class="mb-4" id="members-section" style="display: none;">
                            <label for="academicians" class="block text-white dark:text-gray-200">Project Members</label>
                        ...
                        <!-- Submit Button -->
                        <button type="submit" class="bg-blue-600 text-white font-semibold py-2 px-6 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-300">
                            Add Project Member
                        </button>
                    </form>
                </div>
